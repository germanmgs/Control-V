...
<head>
    ...
    <link rel="stylesheet" href="style.css?v=20250909j">
...
<body>
    ...
    <aside id="side-menu">
        ...
        <div class="menu-section">
            <h3>Catálogo de Ubicaciones (Guardado)</h3>
            <p id="location-catalog-status">Verificando...</p>
            <button id="load-location-btn" class="btn">Recargar Ubicaciones desde GitHub</button>
        </div>
        <div class="menu-section">
            <h3>Limpiar Datos</h3>
            ...
            <button id="clear-guardado-btn" class="btn btn-danger">Limpiar Guardado</button>
        </div>
        <div class="menu-section">
            <h3>Opciones</h3>
    ...
    <main>
        ...
        <div id="almacen-tab" class="tab-content">
            ...
            <form id="almacen-form" class="stock-form">
                ...
                <div class="input-group">
                    ...
                    <div class="input-with-scan">
                        <input type="text" id="almacen-location" placeholder="Ingresar ubicación">
        ...
        <div id="guardado-tab" class="tab-content">
            <h2>Guardado</h2>

            <div id="guardado-marca-banner" class="guardado-marca-banner" style="display:none;">
                <span class="material-icons">local_offer</span>
                <span>Marca fijada: <strong id="guardado-marca-actual"></strong></span>
                <button type="button" id="guardado-marca-quitar" class="btn-link">Quitar</button>
            </div>

            <form id="guardado-form" class="stock-form">
                <div class="input-group">
                    <label for="guardado-sku">Código (Vaxel o Fábrica)</label>
                    <div class="input-with-scan">
                        <input type="text" id="guardado-sku" list="sku-suggestions" placeholder="Escanear mercadería o ingresar código" required>
                        <button type="button" class="scan-btn" data-input="guardado-sku"><span class="material-icons">qr_code_scanner</span></button>
                    </div>
                </div>
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">Buscar Ubicación</button>
                    <button id="export-guardado-btn" class="btn" type="button">Exportar Guardado</button>
                </div>
            </form>
            <div id="guardado-data" class="data-view"></div>
        </div>
    ...
    <div id="scanner-modal" class="modal">
        <div class="modal-content">
            <div id="scanner-container">
                <div id="scan-guide-overlay" class="scan-guide-overlay">
                    <div class="scan-guide-box"></div>
                    <p class="scan-guide-text">Alineá el código de barras dentro del recuadro</p>
                </div>
            </div>
    ...
    <footer id="nav-bar">
        ...
        <button class="nav-btn" data-tab="guardado-tab"><span class="material-icons">move_to_inbox</span><span>Guardado</span></button>
    </footer>

    <script src="app.js?v=20250909j"></script>
</body>
