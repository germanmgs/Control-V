...
async function startScanner() {
    ...
    // FIX: Configuración del escáner (ahora sin las restricciones de video)
    const config = {
        fps: 10,
    ...
    // FIX: Restricciones de la cámara (se pasan como primer argumento a .start())
    ...
    try {
        await html5QrCode.start(
            cameraConstraints, // FIX: El primer argumento debe ser el conjunto de constraints
            config,
            (decodedText) => {
